...
$(document).ready(function(){
	...
	window.open(siteUrl+'/project/producePlan/exportData2?startTime='+$("[x-time-start]").val()+'&endTime='+$("[x-time-end]").val(),
...
function exportExcel(){
	...
	window.open(siteUrl+'/project/producePlan/exportData','_self','width=1,height=1,toolbar=no,menubar=no,location=no');
}