...
$(document).ready(function(){
	...
	window.open(siteUrl+'/project/workExecute/exportData2?startTime='+$("[x-time-start]").val()+'&endTime='+$("[x-time-end]").val(),
			'_self','width=1,height=1,toolbar=no,menubar=no,location=no');
})

function exportExcel(){
	window.open(siteUrl+'/project/workExecute/exportData','_self','width=1,height=1,toolbar=no,menubar=no,location=no');
}