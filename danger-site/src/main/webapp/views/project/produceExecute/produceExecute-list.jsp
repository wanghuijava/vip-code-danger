...
<html>
	...
	<body>
		<form id="list-form" action="/project/produceExecute/find">
			<div class="layout layout-full">
			    <div class="layout layout-search">
	                ...
	                <div class="btn-grp ibm">
	                    <button type="button" class="btn btn-normal" data-href="${siteUrl }/project/produceExecute/addPage">
			    ...
			    <div class="layout layout-search-result">
			        ...
			        <div x-scrollable class="layout layout-table-body cliptb">
						...
						<tr >
		                    ...
		                    <td class="anchor" title="{{item.workName}}"><a href="${siteUrl }/project/produceExecute/viewPage/{{item.id}}">{{item.workName}}</a></td>
		                    ...
		                    <td class="txt-ac  expe">
								...
								<button type="button" class="btn btn-green" data-href="${siteUrl }/project/produceExecute/editPage/{{item.id}}">
									<span class="btn-otr">
										<span class="btn-inr"><i class="icon icon18 icon-edit"></i>编辑</span>
									</span>
								</button>
								<button type="button" class="btn btn-red" data-post-url="/project/produceExecute/delete" data-confirm="" data-post-param='{"id":"{{item.id}}"}'>
									<span class="btn-otr">
						...
						<tr class="project-unexecute">
							...
							<c:if test="${!superior}">
		                    <td class="txt-ac  expe">
								<button type="button" class="btn btn-green" data-href="${siteUrl }/project/produceExecute/addPage?workPlanId={{item.id}}">
									<span class="btn-otr">
	...
	<script src="${siteUrl }/js/project/produceExecute/produceExecute-list.js"></script>
