...
<body>
	...
	<form id="edit-form" action="/project/workPlan/save">
		...
		<div class="layout layout-full">
						...
						<div class="fieldset-content">
							<table class="tb fixedtb">
								...
								<tr>
									...
									<td>
										<div class="ipt-case">
											<input name="param.workName" data-label="危险作业项目名称" data-rule="notnull" maxlength="50" value="{{workName}}"/>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td><div class="ipt-case">
											<select name="param.workLevel"  data-label="作业级别" >
												<option value="">&nbsp;</option>
												<option value="一级" {{if workLevel=='一级'}}selected{{/if}}>一级</option>
												<option value="二级" {{if workLevel=='二级'}}selected{{/if}}>二级</option>
												<option value="三级" {{if workLevel=='三级'}}selected{{/if}}>三级</option>
											</select>
										</div></td>		
			...
			<div class="layout layout-search-result-t-sub">
				<div class="btn-grp fieldset-sub txt-ac">
					...
					<button class="btn btn-gray shim" type="button" data-href="${siteUrl }/project/workPlan/listPage"><span class="btn-otr"><span class="btn-inr">返回</span></span></button>
				</div>
			</div>
		</div>
	</form>
...
<script src="${siteUrl }/js/project/workPlan/workPlan-edit.js"></script>
</html>