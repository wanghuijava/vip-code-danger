...
<body>
	...
	<form id="add-form" action="/project/workPlan/save">
						...
						<div class="fieldset-content">
							<table class="tb fixedtb">
								...
								<tr>
									...
									<td>
										<div class="ipt-case">
											<input name="param.workName" data-label="危险作业项目名称" data-rule="notnull" maxlength="50"/>
										</div>
									</td>
								</tr>
								<tr>
...
<script src="${siteUrl }/js/project/workPlan/workPlan-add.js"></script>
</html>