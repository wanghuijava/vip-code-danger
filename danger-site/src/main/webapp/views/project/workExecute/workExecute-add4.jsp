...
<body>
	...
	<form id="add-form" action="/project/workExecute/save">
							...
							<table class="tb fixedtb">
								...
								<tr>						
									...
									<td><div class="ipt-case">
											<input type="hidden" name="param.orgCode" data-label="主管单位" data-rule="notnull" value="${workPlan.orgCode }"/>
											<input name="param.orgName" data-label="主管单位" data-rule="notnull" value="${workPlan.orgName }" readonly/>
										</div></td>	
								</tr>
								<tr>
									...
									<td>
										<div class="ipt-case">
											<input name="param.workPlanId" value="${workPlan.id}" type="hidden"  data-rule="notnull" />
											<input name="param.workName" value="${workPlan.workName}" readonly  />
										</div>
									</td>
									<th>作业级别:</th>
									<td><div class="ipt-case">
											<input name="param.workLevel" data-label="作业级别" maxlength="10" data-rule="" value="${workPlan.workLevel }">
										</div></td>		
								</tr>
								<tr>
									<th>作业开始时间:</th>
								...
								<tr>
									...
									<td><div class="ipt-case"><textarea name="param.summary" data-label="工程概况" maxlength="500">${workPlan.summary}</textarea>
										</div></td>
									<th>是否进行方案学习交底:</th>
									<td><div class="ipt-case">
								...
								<tr>
									<th>作业审批人:</th>
									<td><div class="ipt-case">
											<input name="param.examiner" data-label="作业审批人" maxlength="10" data-rule="" value="${workPlan.examiner }">
										</div></td>
									<th>作业复核人:</th>
									<td><div class="ipt-case">
											<input name="param.checker" data-label="作业复核人" maxlength="10" data-rule="" value="${workPlan.checker }">
										</div></td>
								</tr>
								<tr>		
									<th>现场指挥:</th>
									<td><div class="ipt-case">
											<input name="param.director" data-label="现场指挥" maxlength="10" data-rule="" value="${workPlan.director }">
										</div></td>		
...
<script src="${siteUrl }/js/project/workExecute/workExecute-add.js"></script>
</html>