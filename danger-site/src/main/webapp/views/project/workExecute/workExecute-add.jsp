						...
						<div class="fieldset-content">
							<table class="tb fixedtb">
								...
								<tr>
									...
									<td>
										<div class="ipt-case">
											<select name="param.workPlanId" data-label="危险作业项目名称" data-rule="notnull" >
												<option value="">--请选择--</option>
												<c:forEach items="${workPlans}" var="workPlan">
													<option value="${workPlan.id}" data-title="${workPlan.workLevel}#@${workPlan.summary}#@${workPlan.examiner}#@${workPlan.checker}#@${workPlan.director}">【${workPlan.executeDateShow}】${workPlan.workName}</option>
												</c:forEach>
											</select>
										</div>
									</td>
