		...
		<div class="pad-10">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
					<form id="editauthorityForm" class="form-horizontal" action="${adminUrl}/admin/authority/authorityEdit" method="post">
						<input type="hidden" name="authorityId" id="authorityId" value="${authority.id}"/>
						<div class="control-group">
							<label class="control-label">权限名称:</label>
							<div class="controls">
								<input type="text" id=authorityName name="authorityName" value="${authority.name }" maxlength="20" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id=authorityUrl name="authorityUrl" value="${authority.url }" maxlength="200" />
