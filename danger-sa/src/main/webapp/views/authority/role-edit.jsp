		...
		<div class="pad-10">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
					<form id="editroleForm" class="form-horizontal" action="${adminUrl}/admin/role/roleEdit" method="post">
						<input type="hidden" name="roleId" id="roleId" value="${role.id}"/>
						<div class="control-group">
							<label class="control-label">角色名称:</label>
							<div class="controls">
								<input type="text" id=rolename name="rolename" value="${role.name }" maxlength="20" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id=comments name="comments" value="${role.comments }" maxlength="20" />
