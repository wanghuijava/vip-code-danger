...
<body>
	<div class="content-menu ib-a blue line-x">
		...
		<span>|</span>
		<a href="javascript:;" class="on"> <em>编辑系统属性</em></a>
	</div>
		...
		<div class="pad-10">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
					<form id="addForm" class="form-horizontal" action="${adminUrl}/basedata/basSysCfgProp/edit" method="post">
						<input type="hidden" value="${entity.propId}" name="propId"/>
						<div class="control-group">
							<label class="control-label">属性名称:</label>
							<div class="controls">
								<input type="text" id="propName" name="propName" readonly value="${entity.propName}" maxlength="100" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="propValue" name="propValue" value="${entity.propValue}" maxlength="200" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea id="propDesc" name="propDesc" cols="5" rows="3">${entity.propDesc}</textarea>
