package com.gsafety.starscream.project.util;
 ...
 * @Date:2015/06/23
 */
public class ExportExcel4Project {
	 ...
	 public static void createExcel(OutputStream os,List<Object[]> listObj,String[] title,String labelTitle,String[] width) throws Exception, WriteException{
		    ...
		    WritableFont times10ptBold = new WritableFont(WritableFont.createFont("宋体"), 20, WritableFont.BOLD,false,UnderlineStyle.NO_UNDERLINE);
		    ...
		    times11BoldFormat.setWrap(true);
			
		    
		    WritableFont titleStyle = new WritableFont(WritableFont.createFont("宋体"), 10, WritableFont.BOLD,false,UnderlineStyle.NO_UNDERLINE);
		    
		    WritableCellFormat threeBorders1 = new WritableCellFormat(titleStyle);
		    threeBorders1.setWrap(true);
		    ...
		    threeBorders2.setVerticalAlignment(VerticalAlignment.CENTRE); // 垂直居中
		    
		    WritableCellFormat threeBorders3 = new WritableCellFormat();
		    threeBorders3.setWrap(true);
		    threeBorders3.setBorder(Border.ALL, BorderLineStyle.THIN);
		    threeBorders3.setAlignment(Alignment.LEFT);
		    threeBorders3.setVerticalAlignment(VerticalAlignment.CENTRE); // 垂直居中
...
//		    sheet.addCell(labelTitle01);
		   ...
		   //定义单元格样式
		    ...
		    for (int i = 0; i < title.length; i++) {
		    	labelTitle00 = new Label(i, 1, title[i], threeBorders1);
		    	sheet.addCell(labelTitle00);
			}
		    int rowNum =2;
		    //表体
